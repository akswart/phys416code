...
def doublepend_data_gen(init_theta1,init_theta2,init_theta1_p,init_theta2_p,param,plotting=False):
    ...
    for istep in range(0,nstep):
        ...
        if istep >= 2 and th2plot[-1]*th2plot[-2] < 0:
            poincare = np.append(poincare,[theta1,theta1_p])
    ...
    p = poincare.reshape((int(poincare.shape[0]/2),2))
    #print(poincare)
    ...
    return th1plot,th2plot,th1_p_plot,th2_p_plot,tplot,p
...
if __name__ == '__main__':
    ...
    th1plot,th2plot,th1_p_plot,th2_p_plot,tplot,p = doublepend_data_gen(init_theta1,init_theta2,init_theta1_p,init_theta2_p,param,True)
    
    param = (.1,.1,10,9.81)
    init_theta1 = np.radians(45)
    init_theta2 = np.radians(45)
    init_theta1_p = np.radians(0)
    init_theta2_p = np.radians(0)
    th1plot,th2plot,th1_p_plot,th2_p_plot,tplot,p = doublepend_data_gen(init_theta1,init_theta2,init_theta1_p,init_theta2_p,param,True)
